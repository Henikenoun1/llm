...
RUN_SUMMARY_PATH = ROOT / "artifacts" / "manifests" / "manual_axolotl_train_run.json"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the Axolotl training pipeline manually stage by stage.")
